  ...
  "use strict"
	...
	describe('The "expandContent" function...', function() {
		...
		describe('...as far as the text is concerned...', function() {
			...
			it('should allow only 30 words to be visible, at first.', function() {
				var content = ($('#textArea')).text();
		        var text = content.split(" ");
		        var len = text.length;

		    	expect(len).toBe(30+2);
			});
			...
			it('should allow only 30 words to be visible, after second click.', function() {
				var link = $('.record-brief-view-more-link');
				link.click();
				link.click();
